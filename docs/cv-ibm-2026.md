...
Passionate Software Engineer with 4+ years in IT, focused on scalable, efficient solutions. Core stack: Java + Spring Boot (back-end), Angular and React/Vue.js + TypeScript (front-end), depending on project.

- Top performer in both 2025 and 2026.
- Also works as a software architect: across three real-world projects, architected multi-agent orchestration pipelines from scratch, automating the full dev lifecycle (code audit → security audit → implementation → code review → PR creation), while retaining final human review/merge authority on every PR.
- Well-versed in Agile/Scrum; cross-cultural communication from local and international team experience.
...
Load Balancing, Caching, Message Queues, Sharding, Read Replicas, Connection Pooling, Session Store, Worker/Background Job Processing, Multi-Agent Orchestration

**Back-end**
Java, Batch Processing, Spring Boot, Jakarta EE, Express, SQL, OracleDB, DB2

**Frontend**
TypeScript, React, Vue, Angular

**Practices & Tooling**
Performance Optimization, Agentic Workflows, Git/GitLab, Code Review & Audit Pipelines
...
**IBM Solutions Delivery, Philippines** | Mar 2025 – Present

Designs, develops, and maintains enterprise-level applications. Full-stack development, API integration, performance optimization.

### Assistant Research and Development Engineer
**Advanced World Solutions, Inc, Philippines** | Oct 2022 – Mar 2025

R&D Engineer specializing in Java, Spring Boot, ReactJS, NodeJS, ExpressJS, Vue. Developed API modules, tested for quality, conducted peer reviews, supported team, integrated front-end/back-end.
...
**Contribution:**
- Recognized as top performer on the NHK Broadcasting System Development Project.
- Japanese-bilingual Application Developer covering both front-end and back-end: investigating, modifying designs, coding, Unit Testing (UT), Integration Testing (ITa).
...
Migrated a property management Windows Desktop Application from C# .NET 4.3 and Java 1.4 to ReactTS and ExpressTS, enabling member companies/stores to register property listings searchable/viewable/inquirable/contractable by consumers. Large scope: 500+ screens, 800+ APIs (screens, reports, file I/O, external linkages).

**Tech stack:** C#, .NET, Java, TypeScript, Node, React, Redmine, Postman, A5M2, SQL, OracleDB, Git, SonarQube, Jest, Jenkins

**Contribution:** Junior Full-Stack Developer specializing in back-end development.
